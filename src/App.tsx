...
function createEmptyDatabase(): Database {
  return {
    ...
    settings: {
      ...
      defaultFollowUpMessage: 'Please contact the clinic pharmacy if symptoms persist, your condition worsens, or you notice unusual side effects.',
...
const builtInMedicineLabelRules: MedicineLabelRule[] = [
  ...
  },
  {
    ...
    followUpMessage: 'Please avoid alcohol while taking metronidazole and for at least 48 hours after completing the course. Contact the clinic pharmacy if you feel unwell.',
    enabled: true,
  },
  {
    ...
    followUpMessage: 'Please complete the antibiotic course exactly as directed, even if you feel better. Contact the clinic pharmacy if you develop rash, severe diarrhea, swelling, or breathing difficulty.',
    enabled: true,
  },
  {
    id: 'built-in-aprovel',
  ...
  },
  {
    ...
    followUpMessage: 'Please take Natrilix in the morning unless otherwise directed, and contact the clinic pharmacy if you feel dizzy or unusually weak.',
    enabled: true,
  },
  {
    ...
    followUpMessage: 'Remember to take your diabetes medicine with meals unless your prescriber advised differently. Keep monitoring your blood sugar and contact the clinic pharmacy if you feel unwell.',
    enabled: true,
  },
  {
    id: 'built-in-bp',
    ...
    followUpMessage: 'Please take your blood pressure medicine at the same time daily and keep monitoring your readings. Contact the clinic pharmacy if you notice severe dizziness or swelling.',
    enabled: true,
  },
  {
...
function defaultLabelInstruction(db: Database, itemType: 'medicine' | 'product', itemId: string) {
  ...
  return combinedInstruction(counselingSuggestionsForMedicine(db, medicine), `Take ${medicineName} exactly as prescribed. Contact the clinic pharmacy if you notice unusual side effects.`)
}
...
function medicineFollowUpInstruction(medicine: Medicine) {
  ...
  return followUp || `Take ${medicine.brandName} exactly as prescribed and contact the clinic pharmacy if you notice unusual side effects.`
}
      ...
      <section className="content-section">
        <div className="section-heading">
          <div>
            ...
            <p>Search by phone, name, or receipt reference across every Totalenergies clinic site.</p>
          </div>
              ...
              <>
                <header className="patient-profile-header">
                  <div>
                    ...
                    <p>{selectedProfile.phone || 'Phone number not recorded'} / {selectedProfile.sales.length} visit{selectedProfile.sales.length === 1 ? '' : 's'} across Totalenergies sites</p>
                  </div>
      ...
      <section className="content-section">
        <div className="section-heading">
          <div>
            ...
            <p>Generated from workspace-wide medicine dispensing records with therapy days captured.</p>
          </div>
        ...
        <div className="counseling-settings full">
          <div className="pricing-settings-head">
            <div>
              ...
              <p>Suggested chips appear in the prescription basket and print on medicine labels only. Reconciliation history stays clean.</p>
            </div>
          </div>
          <div className="pricing-settings-grid">
            ...
            <label className="full">Default follow-up message<textarea value={form.defaultFollowUpMessage ?? ''} onChange={(event) => setForm({ ...form, defaultFollowUpMessage: event.target.value })} disabled={!canAdmin} rows={3} placeholder="Please contact the clinic pharmacy if symptoms persist or side effects occur." /></label>
          </div>
