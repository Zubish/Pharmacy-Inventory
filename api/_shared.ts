...
const defaultMedicineLabelRules: MedicineLabelRule[] = [
  ...
  { id: 'built-in-natrilix', match: 'natrilix, indapamide', label: 'Morning dose', instruction: 'Take Natrilix in the morning unless your prescriber advised a different time.', followUpMessage: 'Please take Natrilix in the morning unless otherwise directed, and contact the clinic pharmacy if you feel dizzy or unusually weak.', enabled: true },
]
