...
export default async function handler(
  ...
  try {
    ...
    if (
      ...
      request.codeHash !== hashToken(code)
    ) {
    ...
    try {
      await sendSecurityEmail(
        email,
        "Your Totalenergies Pharmacy Inventory password was changed",
        "Your Totalenergies Pharmacy Inventory account password was changed using a verification code. If this was not you, contact your account admin immediately.",
      );
    } catch {
